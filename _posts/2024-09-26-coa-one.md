...
- *Associative*: The data is located by a *comparison* with contents of a portion of the store, while ***the time to access a given location is independent of the sequence of prior accesses and is constant.***
    - Devices using this method: *Cache*
