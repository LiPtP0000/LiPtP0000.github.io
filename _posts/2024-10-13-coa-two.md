...
{: .box-note}
**Question 4.8**:Consider a machine with a byte addressable main memory of 64K bytes and block size of 8 bytes. Assume that a **direct-mapped cache consisting of 32 lines** is used with the machine.<br/>
